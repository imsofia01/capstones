        ...
        <div class="result-box custom-box">
            ...
            <table>
                  <tr>
                      ...
                      <td><span class="correctCount" id="correctCountDisplay" name="correctCount">0</span></td>
                  </tr>
                  <tr>
                      <td> <label for="wrongCount"> Maling Sagot </label> </td>
                      <td><span class="wrongCount" id="wrongCountDisplay" name="wrongCount">0</span></td>
                  </tr>
                  <tr>
                    <td> <span for="total"> Kabuoang Tama</label></td>
                    <td><span class="total" id="totalDisplay" type="hidden" name="total" id="quizResultsInput"></span></td>
                </tr>
            </table>
